...
public class InitDb {
    ...
    static class InitService {
        ...
        public void dbInit1() {
            ...
            // 상품
            ProductJpaEntity pro1 = createProduct("JPA1 책", "JPA", "JPA1 BOOK", "JPA", 10000L, 100, "url", categoryJpaEntity1);
            em.persist(pro1);

            ProductJpaEntity pro2 = createProduct("JPA2 책", "JPA", "JPA2 BOOK", "JPA", 20000L, 200, "url", categoryJpaEntity2);
            em.persist(pro2);
