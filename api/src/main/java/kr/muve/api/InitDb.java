...
public class InitDb {
    ...
    static class InitService {
        ...
        public void dbInit1() {
            ...
            // 상품
            ProductJpaEntity pro1 = createProduct("김수환무두루미와거북이김수환무두루미와거북이1", "english", "브랜드", "brand", 10000L, 100, "https://muve-bucket.s3.ap-northeast-2.amazonaws.com/f67247c2-56fa-4378-aeee-56103b557aed.gif", categoryJpaEntity1);
            em.persist(pro1);
...
//
//            OrderCreateCommand command = new OrderCreateCommand(1L, 1, )
//
//            // 주문
//            OrderJpaEntity orderJpaEntity = OrderJpaEntity.createOrder(userJpaEntity, orderProductJpaEntity1);
